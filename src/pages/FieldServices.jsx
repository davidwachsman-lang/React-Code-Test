...
import TempLaborAdmin from '../components/TempLaborAdmin';
...
function FieldServices() {
  ...
  const sections = [
    ...
    {
      id: 'temp-labor',
      title: 'Temp Labor Management',
      description: 'Assign temp workers to crews, track companies and billing rates',
      icon: <TempLaborIcon />
    },
    {
